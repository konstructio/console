...
const DigitalOceanReadinessForm: FunctionComponent<FormFlowProps<InstallValues>> = ({
  control,
  setValue,
}) => {
  ...
  return (
    <>
      ...
      <ControlledPassword
        ...
        helperText="Create your token by following the instructions at https://cloud.digitalocean.com/account/api"
        required
        rules={{
          required: true,
        }}
...
export default DigitalOceanReadinessForm;
