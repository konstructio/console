...
interface ClusterCreationFormProps extends ComponentPropsWithRef<'form'> {
  onFormSubmit: (config: ClusterConfig) => void;
}

const ClusterCreationForm = forwardRef<HTMLFormElement, ClusterCreationFormProps>(
  function ClusterCreationForm({ onFormSubmit, ...rest }, ref) {
    ...
    return (
      <Form ref={ref} onSubmit={handleSubmit(onFormSubmit)} {...rest}>
        <ControlledTextField
          control={control}
          name="clusterName"
